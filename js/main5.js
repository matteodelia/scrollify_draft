(function() {
    ...
    window.CanvasSlideshow = function( options ) {
      ...
      /// ---------------------------
      options                     = options || {};
      options.stageWidth          = options.hasOwnProperty('stageWidth') ? options.stageWidth : 1760;
      options.stageHeight         = options.hasOwnProperty('stageHeight') ? options.stageHeight : 1176;
      ...
      this.initPixi = function() {
        ...
        if (screen.width > 1125) {
          ...
          renderer.view.style.height  = '22vw';
          ...
          renderer.view.style.objectFit = 'cover';
          renderer.view.style.height  = '62vw';
          renderer.view.style.top       = '50%';
          renderer.view.style.left      = '50%';
          renderer.view.style.webkitTransform = 'translate( -50%, -50% ) rotate(90deg)';
          renderer.view.style.transform = 'translate( -50%, -50% ) rotate(90deg)';
